...
{
    /// <summary>
    /// method to load EditContactForm's combobox as per logged in user
    /// </summary>
    public partial class Edit_Contact_Form : Form
    {
        /// <summary>
        ///  method to browse picture 
        ...
        private void buttonSelectContact_Click(object sender, EventArgs e)
        {
            ...
            try
            {
                ...
                textBoxContactId.Text = SelectContactF.dataGridView1.CurrentRow.Cells[0].Value.ToString();
                    ...
                    DataTable table = contact.GetContactById(int.Parse(textBoxContactId.Text));
